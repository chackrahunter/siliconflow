...
<p align="center">
  ...
  <a href="https://github.com/chackrahunter/siliconflow/releases"><img src="https://img.shields.io/badge/Release-v1.0.14-00f2fe?style=for-the-badge&logo=github&logoColor=black" alt="Release v1.0.14"></a>
...
```text
========================================================================
⚡ [SILICONFLOW: P-CORE] | [v1.0.14] | [15:23:05]
...
# build/libs/siliconflow-1.0.14+1.21.4.jar
```
